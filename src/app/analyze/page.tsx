    ...
    <main className="min-h-screen bg-slate-50">
      <div className="max-w-2xl mx-auto px-4 py-10">
        {step === 'upload' && (
          <div className="space-y-6">
            <div className="text-center mb-6">
              <h1 className="text-2xl font-bold text-slate-800 mb-2">Upload Your Screenshot</h1>
              <p className="text-slate-500 text-sm">Take a screenshot of your earnings page</p>
            </div>
            ...
            <div className="text-center">
              <button onClick={() => setStep('calculate')} className="text-blue-600 font-medium text-sm hover:underline">
                Skip screenshot, enter manually →
              </button>
            </div>
          </div>
        )}
        ...
        {step === 'calculate' && (
          <div className="space-y-6">
            <div className="text-center mb-6">
              <h1 className="text-2xl font-bold text-slate-800 mb-2">Calculate Your Real Earnings</h1>
              <p className="text-slate-500 text-sm">Enter your numbers to see the truth</p>
            </div>
            {previewUrl && (
              <div className="card p-4">
                <img src={previewUrl} alt="Screenshot" className="w-full max-h-48 object-contain rounded-lg" />
                <button onClick={() => { setPreviewUrl(null); setStep('upload') }} className="mt-2 text-blue-600 text-sm hover:underline">Change</button>
              </div>
            )}
            <div className="card p-6 space-y-4">
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-1">Base Earnings *</label>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-1">Miles Driven *</label>
          ...
          <div className="space-y-6">
            ...
            <div className="card p-8 text-center">
              ...
              <div className="grid grid-cols-3 gap-4 mb-6">
                ...
                <div className="bg-slate-50 rounded-xl p-3">
                  <p className="text-slate-400 text-xs mb-1">Miles</p>
              ...
              <div className="bg-slate-50 rounded-xl p-4 text-left space-y-2 mb-6">
                ...
                <div className="flex justify-between text-sm">
                  <span className="text-slate-500">Vehicle Cost</span>
              ...
              <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 mb-6">
                <p className="text-emerald-700 font-semibold">🎯 Better than {result.comparisonPercent}% of gig workers</p>
              </div>
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-3 mb-6">
                <p className="text-blue-700 text-sm">💡 <strong>Tax Deduction:</strong> {formatMoney(result.taxDeduction)} in vehicle expenses</p>
              </div>
              <div className="flex flex-col gap-3">
                <button onClick={handleViewCard} className="btn-primary w-full !py-4 text-lg">📤 Generate Share Card</button>
                <div className="flex gap-3">
                  <button onClick={() => { setResult(null); setStep('calculate') }} className="btn-secondary flex-1">Calculate Again</button>
                  <a href="/tracker" className="btn-secondary flex-1 text-center">📊 Tracker</a>
                </div>
              </div>
            </div>
          </div>
